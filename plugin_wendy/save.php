				...
				$result =  get_object_vars($result);*/
					...
					echo '<center>
						...
						<div class="col-lg-6 col-md-6 col-sm-12" style="border: solid 1px #7f7f7f;padding-bottom: 10px;">
							<h5 class="tc-white" > Curso de medios </h5>
							
							<a class="btn btn-lg color-text-asking animSpeedLazy animLoop02 animDelay04 pulse btn-carrot-orange animated" href="http://lab.besign.com.ve/plugin/producto/curso-de-medios/" >
	                                                Ver Mas
	                        </a>
	                    </div>    
					</center >';			
		...
		case 'configuracion':
			...
			if(empty($_POST['accion']))
			{
				$id = $wpdb->insert($wpdb->prefix.'shortcode',array( 
															...
															'descripcion_lateral' => $_POST['comment_lateral'], 
															 array('%s', '%s', '%s', '%s') );		
